...
CREATE TABLE pro_profissionais (
  ...
  prf_tipo_contrato    VARCHAR(40)  NULL COMMENT 'autodeclarado; chave de Support\\Preferencias::CONTRATOS',
  prf_disponibilidade  VARCHAR(120) NULL COMMENT 'autodeclarado; QUALQUER ou lista de UF separada por vírgula: AM,RR',
